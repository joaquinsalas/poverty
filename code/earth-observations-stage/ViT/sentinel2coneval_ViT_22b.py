...
# ViT Model
model = timm.create_model("vit_base_patch16_224", in_chans=24, pretrained=True)
...
for epoch in range(num_epochs):
    ...
    if val_r2 > best_r2:
        best_r2 = val_r2
        patience_counter = 0
        torch.save(model.state_dict(), "../models/model_sentinel2coneval_vit_23b_20250801.pth")
    else:
        patience_counter += 1
...
torch.save({'train_loss': train_history, 'val_loss': val_history}, "../models/history_sentinel2coneval_vit_23b_20250801.pth")

# Test evaluation
model.load_state_dict(torch.load("../models/model_sentinel2coneval_vit_23b_20250801.pth"))
model.eval()
...
# Save test R² to CSV
output_path = "../data/sentinel2coneval_vit_r2_test_20250801.csv"
