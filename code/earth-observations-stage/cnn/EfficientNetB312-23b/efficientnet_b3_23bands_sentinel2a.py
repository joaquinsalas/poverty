...
checkpoint_best = ModelCheckpoint(
    filepath='model_best_val_loss_23bands_efficientnetB3.h5',
    monitor='val_loss',
    save_best_only=True,
...
}).to_csv('training_history_efficientnetb3_23bands.csv', index=False)

model.save('model_efficientnetb3_23bands.h5')
...
model = tf.keras.models.load_model(
    "model_best_val_loss_23bands_efficientnetB3.h5"
)
...
df_pred.to_csv(
    "predictions_test_efficientnet_b3_23bands_sentinel2a.csv",
    index=False
)
